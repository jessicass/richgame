∏作业内容
1.模拟项目开发
   请于2月28日前回复此邮件提交源码测试脚本构建的zip包， 文件名格式为“姓名＋寒假作业”， 开发具体要求附后。
2.寒假学习成果分享
   请准备寒假学习成果分享， 内容和形式不限，分享将在春节后第一期的晔校进行。

参考书目
以下所有书目都有中英文版，请自行选择。
Java语言入门：《Java编程思想》（Thinking in Java）、《Head First Java》
写好Java程序：《Effective Java》
整洁代码：《代码整洁之道》（Clean Code）、《重构》（Refactoring）
测试驱动开发：《测试驱动开发》（Test Driven Development by Example）
模拟项目开发
开发要求
开发语言为Java
编写Clean Code
